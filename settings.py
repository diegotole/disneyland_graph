...
SW_EXTRAS_CONNECTORS = CONNECTION_SW_ADV_LAND | CONNECTION_SW_FRONTIER | CONNECTION_SW_FANTASY
ALL_SETS = SW_EXTRAS_CONNECTORS | C_REGIONS_SETS
REGIONS_LIST = [
    (STAR_WARS_GALAXY_EDGE | SW_EXTRAS_CONNECTORS, "STAR_WARS_GALAXY_EDGE"),
    (TOON_TOWN, "TOON_TOWN"),
    (CRITTER_COUNTRY, "CRITTER_COUNTRY"),
    (NEW_ORLEANS_SQUARE, "NEW_ORLEANS_SQUARE"),
    (FRONTIER_LAND | CONNECTION_SW_FRONTIER, "FRONTIER_LAND"),
    (ADVENTURE_LAND | CONNECTION_SW_ADV_LAND, "ADVENTURE_LAND"),
    (MAIN_STREET, "MAIN_STREET"),
    (TOMORROW_LAND, "TOMORROW_LAND"),
    (FANTASY_LAND | CONNECTION_SW_FANTASY, "FANTASY_LAND")
